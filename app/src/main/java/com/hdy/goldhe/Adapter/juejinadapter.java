...
public class juejinadapter extends BaseAdapter{
        private Context context;
        private JSONArray array;
        private LayoutInflater inflater=null;
        public juejinadapter(Context context, JSONArray array)
        {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            try {
               ...
               viewHolder.title.setText(Object.get("title").toString());
                ...
                String text="收藏人数："+Object.get("collectionCount").toString()+"\n查看人数："+Object.get("viewsCount").toString()+"\n热门指数："+Object.get("hotIndex").toString();
