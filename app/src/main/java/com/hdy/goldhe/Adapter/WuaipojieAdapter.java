...
public class WuaipojieAdapter extends BaseAdapter {
    private Context context;
    private JSONArray array;
    private LayoutInflater inflater=null;
    public WuaipojieAdapter(Context context, JSONArray array)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        WuaipojieAdapter.ViewHolder viewHolder;
        if (convertView == null) {
            viewHolder = new WuaipojieAdapter.ViewHolder();
            ...
            viewHolder = (WuaipojieAdapter.ViewHolder) convertView.getTag(); // 获取，通过ViewHolder找到相应的控件
        }
        try {
            ...
            viewHolder.detail.setText(Object.get("detail").toString());
