...
public class news extends Fragment {
    ...
    protected void initView() {
        viewPager = findView(R.id.news_viewpager);
        tabLayout = findView(R.id.newstab);
        initData();
        initTab();
    }
    ...
    public void initViewPagerAdapter() {
        ...
        //设置viewpager的适配器
        Fragment[] fragments = {new fragment_zhihu(),new fragment_wuaipojie(),new fragment_guoke2()};
    ...
    public void initTab(){
        try {
            ...
            tabLayout.getTabAt(1).setText("吾爱");
            tabLayout.getTabAt(2).setText("果壳");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
